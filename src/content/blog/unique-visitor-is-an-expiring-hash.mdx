...
[^3]: A. Barth, [RFC 6265: HTTP State Management Mechanism](https://www.rfc-editor.org/rfc/rfc6265), IETF, April 2011 — the cookie mechanism that cookieless analytics avoids.
[^4]: Umami documentation, [Environment variables](https://docs.umami.is/docs/environment-variables) — `SALT_ROTATION`, `APP_SECRET`, `DISABLE_BOT_CHECK`, `IGNORE_IP` and `SKIP_LOCATION_HEADERS`.
